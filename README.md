# Minesweeper-SO2
A simple Minesweeper game implemented in **C** using the **Win32 API**.  
This project was created while studying for a college exam.
...
- Automatically reveals empty cells and their neighbors
